    ...
    <div className="w-full">
      ...
      <div className="mb-7">
        ...
        <p className="mt-2 text-[0.925rem] leading-relaxed text-[var(--ef-muted-foreground)]">
          ...
          Sign in to continue to your ExpenseFlow dashboard.
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <a
              href="#"
              className="rounded-sm text-[0.8rem] font-medium text-[var(--ef-primary)] underline-offset-4 outline-none transition-colors hover:text-[color-mix(in_oklch,var(--ef-primary)_80%,transparent)] hover:underline"
            >
              Forgot password?
            </a>
  ...
  return (
    ...
    <div className="space-y-2">
      ...
      <div className="group relative">
        ...
        <span className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-[var(--ef-muted-foreground)]">
  ...
  return (
    ...
    <style>{`
      ...
      .ef-input {
        ...
        box-shadow: 0 1px 2px rgba(16, 40, 34, 0.05);
        transition:
          color 0.2s,
          box-shadow 0.2s,
          border-color 0.2s;
      ...
      .ef-animate-in {
        animation: ef-fade-in 0.7s ease-out both;
      }
